...
int main()
{
    ...
    for (int i = 0; i < num_files; i++)
    {
        ...
        int total_value_dp_bu = 0, total_value_dp_td = 0, total_value_greedy = 0, total_value_ga = 0, total_timelimit_value_ga = 0;
        ...
        // Calculate greedy averages for used in GA algorithm
        ...
        {
            clock_gettime(CLOCK_MONOTONIC, &start);
            result = GA_Knapsack(n, weights, values, W, avg_time_greedy, &ga_timelimit_result);
            clock_gettime(CLOCK_MONOTONIC, &end);
