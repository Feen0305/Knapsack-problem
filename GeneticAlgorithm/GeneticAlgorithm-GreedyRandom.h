...
static int GreedyRandom_GA_Process(int n, int *weights, int *values, int W, double Time_Limit, int *Time_Limit_Result)
{
...
int GreedyRandom_GA_Knapsack(int n, int *weights, int *values, int W, double Time_Limit, int *Time_Limit_Result)
{
    // printf("[COMP]Starting Genetic Algorithm knapsack computation...\n");
    return GreedyRandom_GA_Process(n, weights, values, W, Time_Limit, Time_Limit_Result);
}
